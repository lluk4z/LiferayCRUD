package task.rest.internal.resource.v1_0.factory;
...
import task.rest.internal.security.permission.LiberalPermissionChecker;
 ...
 */
@Component(
	property = "resource.locator.key=/task-rest/v1.0/Task",
