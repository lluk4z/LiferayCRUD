package task.rest.client.resource.v1_0;
...
import task.rest.client.problem.Problem;
...
public interface TaskResource {
	...
	public HttpInvoker.HttpResponse deleteTaskHttpResponse(Integer taskId)
		throws Exception;

	public void deleteTaskBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse deleteTaskBatchHttpResponse(
			String callbackURL, Object object)
		throws Exception;

	public Task getTask(Integer taskId) throws Exception;

	public HttpInvoker.HttpResponse getTaskHttpResponse(Integer taskId)
		throws Exception;

	public Page<Task> getTasks() throws Exception;

	public HttpInvoker.HttpResponse getTasksHttpResponse() throws Exception;
	...
	public static class TaskResourceImpl implements TaskResource {
		...
		public void deleteTask(Integer taskId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = deleteTaskHttpResponse(
				taskId);
		...
		public void deleteTaskBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse = deleteTaskBatchHttpResponse(
				callbackURL, object);
		...
		public Task getTask(Integer taskId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getTaskHttpResponse(taskId);
		...
		public Page<Task> getTasks() throws Exception {
			HttpInvoker.HttpResponse httpResponse = getTasksHttpResponse();
		...
		public HttpInvoker.HttpResponse getTasksHttpResponse()
			throws Exception {
