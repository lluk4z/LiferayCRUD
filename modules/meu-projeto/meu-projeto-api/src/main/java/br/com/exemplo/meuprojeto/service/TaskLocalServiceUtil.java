...
package br.com.exemplo.meuprojeto.service;
 ...
 * <code>br.com.exemplo.meuprojeto.service.impl.TaskLocalServiceImpl</code> and
...
public class TaskLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>br.com.exemplo.meuprojeto.service.impl.TaskLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static Task addTask(long userId, String title, String description)
	...
	public static Task updateTask(
		...
		return getService().updateTask(
			taskId, title, description, completed, serviceContext);
	}
