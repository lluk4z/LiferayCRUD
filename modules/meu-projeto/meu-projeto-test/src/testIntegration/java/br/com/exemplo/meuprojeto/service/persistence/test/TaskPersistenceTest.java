...
package br.com.exemplo.meuprojeto.service.persistence.test;

import br.com.exemplo.meuprojeto.exception.NoSuchTaskException;
import br.com.exemplo.meuprojeto.model.Task;
import br.com.exemplo.meuprojeto.service.TaskLocalServiceUtil;
import br.com.exemplo.meuprojeto.service.persistence.TaskPersistence;
import br.com.exemplo.meuprojeto.service.persistence.TaskUtil;
...
public class TaskPersistenceTest {
	...
	public static final AggregateTestRule aggregateTestRule =
		new AggregateTestRule(
			...
			new TransactionalTestRule(
				Propagation.REQUIRED, "br.com.exemplo.meuprojeto.service"));
	...
	protected OrderByComparator<Task> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"MP_Task", "taskId", true, "title", true, "description", true,
			"completed", true, "groupId", true, "companyId", true, "userId",
